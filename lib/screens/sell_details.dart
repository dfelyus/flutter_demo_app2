...
class SellDetails extends StatefulWidget {
  ...
  @override
  _SellDetails createState() => _SellDetails();
}

class _SellDetails extends State<SellDetails> {
//---------------ADD DATA -----------------------------
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.tealAccent,
        title: Text('Sell',style: TextStyle(color: Colors.deepPurple,fontWeight: FontWeight.bold),),
        shape: Border.symmetric(horizontal: BorderSide.none),
      ),
      body: Column(
        children: [
          Container(
            decoration: BoxDecoration(color: Colors.black12,borderRadius: BorderRadius.circular(30.0)),
            height: 400,
            ...
            child: Row(
              ...
              children: [
                MaterialButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/icons/icon_add.png",
                        height: 35,
                      ),
                ...
                MaterialButton(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/icons/sell2.png",
                        height: 35,
                      ),
                      Text("Sell",style: TextStyle(fontSize: 14,color: Colors.white),),
                    ],
                  ),
                ),
              ],
